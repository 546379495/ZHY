...
public class AvatarImageView extends ImageView {
    ...
    //-----------------------------------用法------------------------------
    //1、设置头像设置完成后的回调时间、此自定义控件 自动点击事件监听
//    img.setAfterCropListener(new AvatarImageView.AfterCropListener() {
//        @Override
//        public void afterCrop(Bitmap photo) {
//       //头像设置完成
//        }
//    });
  //2、重写 onActivityResult方法 形参传入自定义控件中
//    @Override
...
//    }
    ...
    public class AvatarDialog extends AlertDialog {
        ...
        private final CharSequence CHOOSE_PIC_BTN_SHOW = "相 册";
        private final CharSequence TITLE_SHOW = "选择";
